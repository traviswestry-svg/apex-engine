...
# ── Route registration (absorbed from continuous_learning_routes.py, Sprint 3).
from flask import jsonify, request  # noqa: E402
from . import continuous_learning_calibration as calibration  # self-alias for absorbed route body
