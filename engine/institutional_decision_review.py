...
# ── Route registration (absorbed from institutional_decision_review_routes.py, Sprint 3).
from flask import jsonify, request  # noqa: E402
import hmac  # noqa: E402  (operator-token authorization for absorbed routes)
from . import institutional_decision_review as review  # self-alias for absorbed route body
...
def register_institutional_decision_review_routes(app, *, last_result_provider=None):
    def current_payload():
