...
# ── Route registration (absorbed from institutional_decision_integrity_routes.py, Sprint 3).
from flask import jsonify, request  # noqa: E402
from . import institutional_decision_integrity as integrity  # self-alias for absorbed route body
...
def register_institutional_decision_integrity_routes(app, *, last_result_provider=None):
    def current_payload():
