...
# ── Route registration (absorbed from decision_outcome_forecast_routes.py, Sprint 3).
from flask import jsonify, request  # noqa: E402
from . import decision_outcome_forecast as forecast  # self-alias for absorbed route body
...
def register_decision_outcome_forecast_routes(app, *, last_result_provider=None):
    def current_payload():
