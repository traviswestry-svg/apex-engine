...
def test_release_truth_and_guardrails():
    ...
    assert m['apex_version']==m['semantic_version']==m['application_version']=='69.10.11'
    assert m['build_name']=='Immutable Historical Evidence Archive & Dependency-Preserving Projection Foundation'
    g=m['guardrails']
