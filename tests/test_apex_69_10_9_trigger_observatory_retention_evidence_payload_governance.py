...
def test_release_truth_and_guardrails():
    ...
    assert m['apex_version']==m['semantic_version']==m['application_version']=='69.10.12'
    assert m['build_name']=='Scanner Process Authority & Cross-Process Health Truth Closure'
    g=m['guardrails']
