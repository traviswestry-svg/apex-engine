...
def test_release_truth_and_guardrails():
    ...
    assert m['apex_version']==m['semantic_version']==m['application_version']=='69.10.10'
    assert m['build_name']=='Historical Evidence Payload Dependency & Compaction Readiness'
    g=m['guardrails']
